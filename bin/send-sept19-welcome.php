...
$recipients = [
    [
        'name' => 'Glenda Atkins',
        'username' => 'glendaatkins',
        'email' => 'glenda.atkins@gmail.com',
        'password' => 'AtkinsFootball2026!',
    ],
    [
        'name' => 'John Sigalas',
        'username' => 'jsigalas',
        'email' => 'jsigalas@outlook.com',
        'password' => 'SigalasFootball2026!',
    ],
    [
        'name' => 'SW Sigalas',
        'username' => 'swsigalas',
        'email' => 'swsigalas@outlook.com',
        'password' => 'SWSigalasFootball2026!',
    ],
];
...
echo "============================================================\n";
echo "Dispatching Welcome Emails for Glenda Atkins & The Sigalas\n";
...
<body>
    <div class="container">
        ...
        <!-- Week 2 Alert Banner -->
        <div style="background-color: #1e293b; border: 1px solid #3b82f6; border-radius: 12px; padding: 14px 18px; margin-bottom: 20px; font-size: 13px; color: #e2e8f0; line-height: 1.5;">
            ⚡ <strong>Week 2 Slate Open:</strong> Thursday's opening game has wrapped, but all <strong>15 Sunday and Monday games</strong> are wide open for your picks! Each game locks individually at kickoff time, so jump in and get your Week 2 picks submitted!
        </div>
        ...
        <div class="card card-gold">
            ...
            <div class="card-text">
                ...
                <ul style="margin: 10px 0 10px 20px; padding: 0;">
                    ...
                    <li style="margin-bottom: 8px;">
                        <strong>Daily Morning Briefing:</strong> Receive an automatic, personalized morning status email with your overnight results, current league rank, and upcoming slate whenever games finish.
                    </li>
                    <li>
...
HTML;
    ...
    $textBody = <<<TEXT
============================================================
WELCOME TO ATKINS NFL POOL — {$name}!
============================================================
...
⚡ NFL WEEK 2 PICKS OPEN:
Thursday's opening game has wrapped, but all 15 Sunday and Monday games
are wide open for your selections! Each game locks individually at kickoff time.
...
TEXT;
    ...
    $headers = [
        ...
        "List-Unsubscribe: <https://football.wallyatkins.com/preferences?email=" . urlencode($effectiveEmail) . ">",
    ...
    echo "Dispatching welcome email to {$name} <{$effectiveEmail}>...\n";

    if ($isDryRun) {
        echo "  [DRY-RUN] Prepared welcome message for {$username} successfully.\n\n";
        $sentCount++;
        continue;
    }

    $success = @mail($effectiveEmail, $subject, $body, $headersString, "-f {$fromEmail}");
...
echo "Summary: Sent={$sentCount}, Failed={$failedCount}\n";
