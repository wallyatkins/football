...
$recipientEmail = 'michelle.r.weaver@gmail.com';
$recipientName = 'Michelle Weaver';
    ...
    <div class="container">
        ...
        <div class="credentials-box">
            ...
            <div class="cred-row">
                ...
                <span class="cred-val">michelleweaver</span>
            </div>
            <div class="cred-row">
            ...
            <div class="cred-row">
                ...
                <span class="cred-val">WeaverFootball2026!</span>
            </div>
            <div class="cred-row">
        ...
        <div style="background-color: #1e293b; border: 1px solid #3b82f6; border-radius: 12px; padding: 14px 18px; margin-bottom: 20px; font-size: 13px; color: #e2e8f0; line-height: 1.5;">
            ⚡ <strong>Week 2 Kickoff Tomorrow:</strong> Thursday Night Football (Detroit Lions @ Buffalo Bills) kicks off Thursday, Sep 17 at 8:15 PM EDT. Get your Week 2 picks locked in right away!
        </div>
...
- Username: michelleweaver
- Email: {$recipientEmail}
- Temporary Password: WeaverFootball2026!
- Passwordless: Magic 6-digit code via email is also supported!
- Account Management: https://auth.wallyatkins.com/account

⚡ NFL WEEK 2 KICKOFF:
Thursday Night Football (DET @ BUF) kicks off Thursday, Sep 17 at 8:15 PM EDT.
